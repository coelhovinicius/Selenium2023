...
function validarFormulario() {
  ...
  if (comentarios.length > 1000 || comentarios.length < 3) {
    exibirErro('comentarios', 'Mínimo de 2 e máximo de 1000 caracteres');
    return false;
  }
...
/*function validarTelefone(telefone) {
  var padraoTelefone = /^\d{10,14}$/; // Aceita somente números e verifica a quantidade de caracteres
